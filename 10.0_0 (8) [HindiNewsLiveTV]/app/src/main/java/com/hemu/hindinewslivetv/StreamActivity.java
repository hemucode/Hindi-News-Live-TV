...
public class StreamActivity extends AppCompatActivity {
        ...
        if (category.equals("m3u8")) {
            ...
            fullScreen.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mInterstitialAd != null && oneTimeRun) {
                        mInterstitialAd.show(StreamActivity.this);
    ...
    public void loadAds() {
        ...
        InterstitialAd.load(StreamActivity.this,getString(R.string.InterstitialAd), adRequest,
